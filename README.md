...
[![Selenium](https://img.shields.io/badge/Selenium-4.10.0-green)](https://www.selenium.dev/)
[![Excel](https://img.shields.io/badge/Excel-TestCases-success?logo=microsoft-excel)](https://www.microsoft.com/en-us/microsoft-365/excel)
[![Manual Testing](https://img.shields.io/badge/Manual-Testing-orange)](#)
[![Bug Reporting](https://img.shields.io/badge/Bug-Reporting-red)](#)
[![Black-Box Testing](https://img.shields.io/badge/BlackBox-Testing-yellow)](#)
...
| Script | Description |
|--------|-------------|
| `amazon_add_to_cart.py` | Automates product search and adding items to the cart on Amazon. Handles dynamic page elements with explicit waits. |
| `test_web_form.py` | Automates filling a demo web form, interacts with text fields, dropdowns, checkboxes and advanced inputs (date picker, range slider), and validates form submission. |
